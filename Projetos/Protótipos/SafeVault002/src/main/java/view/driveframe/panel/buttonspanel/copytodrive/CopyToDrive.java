package view.driveframe.panel.buttonspanel.copytodrive;
...
public class CopyToDrive extends JButton {
	
	private ButtonsPanel buttons_panel;
	
	public CopyToDrive(ButtonsPanel buttons_panel) {
	...
	private void icon() {
		String path = "angle-double-left.png";
	    URL imgURL = getClass().getResource(path);
	    
	    if (imgURL != null)
			this.setIcon(new ImageIcon(imgURL, "Copiar para o drive"));
	    else
    		this.setText("<<");
	}
