...
public class Utility {
	...
	public static Drive getDrive(String tokenName) throws Exception {
		HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
		
		return new Drive(HTTP_TRANSPORT, JSON_FACTORY, getCredentials(tokenName));
	}

	private static Credential getCredentials(String tokenName) throws Exception {
		...
		java.io.File tokenDirectory = new java.io.File(TOKEN_DIRECTORY + tokenName);
