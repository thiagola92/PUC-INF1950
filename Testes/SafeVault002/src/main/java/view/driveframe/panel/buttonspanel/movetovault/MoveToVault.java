package view.driveframe.panel.buttonspanel.movetovault;
...
public class MoveToVault extends JButton {
	
	private ButtonsPanel buttons_panel;
	
	public MoveToVault(ButtonsPanel buttons_panel) {
	...
	private void icon() {
		String path = "angle-right.png";
	    URL imgURL = getClass().getResource(path);
	    
	    if (imgURL != null)
			this.setIcon(new ImageIcon(imgURL, "Mover para o vault"));
	    else
    		this.setText(">");
	}
